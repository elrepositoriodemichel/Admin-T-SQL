...
| Campo | Descripción | Cuándo preocuparse |
|---|---|---|
| `Total VLF Count` | Número total de VLFs en el fichero de log | Valores elevados (generalmente > 200) pueden indicar fragmentación del log y ralentizar la recuperación — considerar redistribución |
